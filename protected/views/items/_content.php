    ...
    <div class="image-block" >
                    ...
                    <div class="hm" style="position: absolute; top: <?php echo $comment->y?>%; left: <?php echo $comment->x?>%;">
                        <div class="border">
                            <i class="glow glow_<?php echo $comment->avatar; ?>">
                                <div class="com-text">
                                    <div class="text" <?php echo (strlen(CHtml::encode($comment->content))>30) ? "style='width: 120px'" : (strlen(CHtml::encode($comment->content))>100) ? "style='width:250px'" : ''; ?>>
        ...
        <?php
            ...
            $("#image_'.$model->id.'").live("click",function(e){
                ...
                var xClick = e.pageX - $(this).offset().left - 15;
