...
<div id="shades">
    <div class="shade">
        <div class="inner">
            <a class="sortBy" data-type="published_at" data-dir="asc" href="<?php echo Yii::app()->createUrl($this->route, array('sort_type' => 'published_at', 'sort_dir' => 'asc')); ?>">
                <i class="sprite sprite_arrow_white_top" title="Сортировать по-возрастанию"></i>
            </a>
            <span>
                <i class="sprite sprite_time_white" title="Сортировать по времени"></i>
            </span>
            <a class="sortBy" data-type="published_at" data-dir="desc" href="<?php echo Yii::app()->createUrl($this->route, array('sort_type' => 'published_at', 'sort_dir' => 'desc')); ?>">
                <i class="sprite sprite_arrow_white_bottom" title="Сортировать по-убыванию"></i>
            </a>
        </div>
    </div>
    <div class="shade">
        <div class="inner">
            ...
            <span>
                <i class="sprite sprite_comments_white" title="Сортировать по количеству комментариев"></i>
            </span>
    ...
    <div class="shade">
        <div class="inner">
            ...
            <span>
                <i class="sprite sprite_comments_time" title="Сортировать новым комментариям"></i>
            </span>
            <a class="sortBy" data-type="update_at" data-dir="desc" href="<?php echo Yii::app()->createUrl($this->route, array('sort_type' => 'updated_at', 'sort_dir' => 'desc')); ?>">
                <i class="sprite sprite_arrow_white_bottom" title="Сортировать по-убыванию"></i>
            </a>
        </div>
    </div>
