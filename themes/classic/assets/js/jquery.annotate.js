...
(function($) {
    ...
    $.fn.annotateImage = function(options) {
        ...
        if (this.editable) {
            this.button = $('<a class="image-annotate-add" id="image-annotate-add" href="javascript:void(0)">Добавить заметку</a>');
    ...
    **/
    ...
    $.fn.annotateImage.createSaveButton = function(editable, image, note) {
        ...
        ok.click(function() {
            ...
            if (text.length == 0) {
                alert('Введите текст комметария!');
                return false;
            }
